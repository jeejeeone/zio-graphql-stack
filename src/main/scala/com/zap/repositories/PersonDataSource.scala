    ...
    ZLayer:
      ...
      yield new PersonDataSource:
        override lazy val personDataSource: UDataSource[GetPerson] =
          Batched.make[Any, GetPerson]("PersonDataSource"):
            requests =>
              ...
              requests.toList match
                ...
                case batch =>
                  ...
                  val res = result.fold(
                    ...
                    success => success.foldLeft(resultMap) { case (map, person) =>
        ...
        override lazy val allPersonsDataSource = DataSource.fromFunctionZIO[Any, Throwable, GetAllPersons, List[PersonRow]]("AllPersonsDataSource"):
          r => personService.getPersons()